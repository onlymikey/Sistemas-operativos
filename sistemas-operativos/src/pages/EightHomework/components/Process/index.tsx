...
export default function Process({
  ...
  return (
    ...
    >
      <Card
        data-status={status}
        className="w-full h-auto bg-blue-400/20 border-1 border-dashed
        data-[status='Suspendido']:bg-red-500/20 data-[status='Suspendido']:border-red-500
        border-blue-400 data-[status='Ejecutando']:bg-green-500/20 data-[status='Ejecutando']:border-green-500
      data-[status='Error']:bg-red-500/20 data-[status='Error']:border-red-500
       data-[status='Bloqueado']:bg-red-500/20 data-[status='Bloqueado']:border-red-500"
      >
        <CardBody>
          <Progress
